      ...
      <section style={{ backgroundColor: '#1f2232', color: '#fff', borderBottom: '6px solid #e51937' }}>
        <div className="container" style={{ paddingTop: '6rem', paddingBottom: '6rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link
              href="/products"
              style={{ backgroundColor: '#e51937', color: '#fff', padding: '16px 40px', fontWeight: 700, fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.1em', textDecoration: 'none' }}
            >
              {t('home_hero_cta')}
            </Link>
            {!isLoggedIn && (
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={label} style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#fff', border: '1px solid #e5e7eb', borderTop: '3px solid #e51937' }}>
                <p style={{ fontSize: '1.4rem', fontWeight: 900, color: '#1f2232', marginBottom: '0.25rem' }}>{value}</p>
      ...
      {!isB2B && (
        <section style={{ backgroundColor: '#1f2232', borderTop: '6px solid #e51937', borderBottom: '6px solid #e51937', paddingTop: '4rem', paddingBottom: '4rem' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            ...
            <div style={{ width: 60, height: 5, backgroundColor: '#e51937', margin: '0 auto 1.5rem' }} />
            <p style={{ color: 'rgba(255,255,255,0.7)', maxWidth: 560, margin: '0 auto 2rem', lineHeight: 1.8, fontSize: '0.95rem' }}>
              {t('home_b2b_sub')}
            </p>
            <Link
              href="/auth/register"
              style={{ backgroundColor: '#e51937', color: '#fff', padding: '14px 36px', fontWeight: 700, fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.1em', textDecoration: 'none' }}
            >
              {t('home_b2b_cta')}
            </Link>
          </div>
