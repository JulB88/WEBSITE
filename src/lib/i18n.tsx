...
const T = {
  fr: {
    ...
    quantity: 'Quantité :',
    b2b_savings: 'Tarification client entreprise appliquée. Vous économisez {{n}} $ sur cet article.',
    ...
    account_business: 'Compte entreprise',
    ...
    register_business: 'Entreprise B2B',
  ...
  en: {
    ...
    description: 'Description',
    quantity: 'Quantity:',
    b2b_savings: 'Business customer pricing applied. You save ${{n}} on this item.',
    ...
    register_business: 'B2B Business',
